...
import { getSession, resetPassword, verifyEmail } from '@/lib/portal-api';
...
function SessionRedirect() {
  ...
  useEffect(() => {
    ...
    router.replace(user ? (user.role === 'admin' ? '/admin/dashboard' : '/dashboard') : '/login');
  }, [router]);
