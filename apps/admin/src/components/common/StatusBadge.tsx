...
export function StatusBadge({ status, customLabel }: StatusBadgeProps) {
  ...
  return (
    <span className={`inline-flex whitespace-nowrap items-center gap-1.5 px-2 py-0.5 rounded border text-[12px] font-medium leading-4 ${style.bg} ${style.text} ${style.border}`}>
