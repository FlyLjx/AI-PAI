...
import {
  ...
  Gauge, LogOut, Mail, Megaphone, Menu, Package, Radio, ReceiptText, ScanSearch, ShieldCheck, Users, X,
} from 'lucide-react';
...
const adminNav = [
  ...
  { label: '公告管理', href: '/announcements', icon: Megaphone },
  { label: '邮件记录', href: '/mail-logs', icon: Mail },
